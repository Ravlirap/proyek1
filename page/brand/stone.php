...
<body>
    <section id="products" class="products">
        ...
        <div class="product-container">
            ...
            $sql = "SELECT id_produk, nama, gambar, harga, stok, jenis FROM produk WHERE nama LIKE '%stone island%'";
            ...
            if ($result->num_rows > 0) {
                ...
                echo '<p style="text-align:left; color:#1a1aff; width:100%;">Belum ada produk.</p>';
            }
            ?>
        </div>
    </section>
